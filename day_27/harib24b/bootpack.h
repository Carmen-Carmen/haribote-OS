...
#define KBD_UP                  0xf0
#define KBD_DOWN                0xf1
#define KBD_LEFT                0xf2
#define KBD_RIGHT               0xf3
...
struct TIMER {                  // 定时器结构体
    ...
    char flags, flags2;         // 计时器的状态(OS); 计时器状态(区分是否需要在应用程序结束时自动取消)
