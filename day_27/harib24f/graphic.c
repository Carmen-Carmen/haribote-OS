...
void init_screen8(char *vram, int x, int y) {
    ...
    // windows按钮？
    boxfill8(vram, x, COL8_FFFFFF,      3, y - 24,     69, y - 24); // 白色上边框
    boxfill8(vram, x, COL8_FFFFFF,      2, y - 24,      2, y -  4); // 白色左边框
    boxfill8(vram, x, COL8_848484,      3, y -  4,     69, y -  4); // 深灰色下边框
    boxfill8(vram, x, COL8_848484,     69, y - 23,     69, y -  5); // 深灰色右边框
    boxfill8(vram, x, COL8_000000,      2, y -  3,     69, y -  3); // 黑色下边框
    boxfill8(vram, x, COL8_000000,     70, y - 24,     70, y -  3); // 黑色右边框
