...
//     char s[12];
//     for (index_name = 0; index_name < 11; index_name++) {
//         s[index_name] = ' ';
//     }
//     index_name = 0;

//     for (index_name = 0; name[index_name] != 0; index_name++) {
//         if (index_name >= 11) {
//             // 文件名长于8个，找不到
//             return 0;
//         }

//         if (name[index_name] == '.' && index_name <= 8) {
//             index_name = 8;
//         } else {
//             s[index_name] = name[index_name];
//             if ('a' < s[index_name] && s[index_name] < 'z') {
//                 s[index_name] -= 0x20;
//             }
//         }
//     }
...
//     cons.cur_x = 8;
//     cons_putstring(&cons, name, COL8_FFFFFF, COL8_000000, 0, 11);
//     cons_newline(&cons);

//     for (index_file = 0; index_file < max; ) {
//         if (finfo[index_file].name == 0x00) {
//             break;  // 找到空文件了，遍历完了
//         }

//         if ((finfo[index_file].type & 0x18) == 0) {
//             for (index_name = 0; index_name < 11; index_name++) {
//                 if (finfo[index_file].name[index_name] != s[index_name]) {
//                     goto next;
//                 }
//             }
//             return finfo + index_file;   // 找到文件
//         }
// next: 
//         index_file++;
//     }
