...
void HariMain(void) {
    ...
    putstring8_ascii_sht(sht_win, 24, 28, COL8_000000, COL8_C6C6C6, "Welcome to");
    putstring8_ascii_sht(sht_win, 24, 44, COL8_000000, COL8_C6C6C6, "  Haribote-OS!");
    ...
    char timerbuf[8];       // 同时超时的timer一般不会超过8个吧
    struct TIMER *timer1, *timer2, *timer3;
    
    fifo8_init(&timerfifo, 8, timerbuf);    // 初始化timer的缓冲区
    timer1 = timer_alloc();                 // 分配timer
    timer_init(timer1, &timerfifo, 10);     // 初始化timer
