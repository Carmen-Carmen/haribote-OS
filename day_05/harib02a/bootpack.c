...
void HariMain(void) {
    ...
    // 这些信息都应该从内存中获取不能写死，而asmhead.asm在启动时完成了将这些信息写入内存
    int xsize, ysize;
    char *vram;   
    short *binfo_scrnx, *binfo_scrny;// bootinfo_screen_x, bootinfo_screen_y
    int *binfo_vram;
    
    // 给指针赋值
    binfo_scrnx = (short *) 0x0ff4; // word
    binfo_scrny = (short *) 0x0ff6;
    binfo_vram = (int *) 0x0ff8     // dword
